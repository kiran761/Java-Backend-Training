...
public class MyRestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> errotHandler(InvalidValueException e,WebRequest req)
    {
    ...
    @ResponseStatus(HttpStatus.NOT_ACCEPTABLE)
    protected ResponseEntity<Object> errotHandler(Exception e,WebRequest req)
    {
